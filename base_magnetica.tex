...
\begin{figure}[h]
\centering
	\includegraphics[width=0.9\columnwidth]{figs/base/esquematico}
...
\begin{figure}[h!]
\centering
	\includegraphics[width=0.8\columnwidth]{figs/base/mapa}
...
\begin{figure}[h!]
\centering
	\includegraphics[width=0.5\columnwidth]{figs/base/fotos}
